...
int main(int argc, char* argv[]) {
	...
	if (argc != 5) {
		...
		cout << "Usage:  \n";
		cout << "./mapper <path_to_the_input_aag_converted_from_blif> <LUT_size_(K)> <output_file_name> <CLB size> \n";
		exit(1);
	}
	...
	for (vector<int>* temporary : trees_inverse)
		delete[] temporary;

	for (Look_Up_Table** LUTs : trees_LUTs) {
