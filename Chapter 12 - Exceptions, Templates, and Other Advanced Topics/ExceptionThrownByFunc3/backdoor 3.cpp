...
void Xtest(int test) {
	...
	if (test)
		throw test; // This thrown exception is caught by the catch statement in main(), even if 
					// this function's return type is void. (After all, "return" and "throw" aren't the same.)
}
