...
int main(void)
{
    ...
    for (int i = 0; i < n; i++) {
        ...
        printf("a[%d] sits at %p / %p / %p\n", i, (void *)&a[i], (void *)(ip + i), (void *)(cp + i * sizeof(int)));
    }
...
// Source: https://github.com/Apress/pointers-c-programming/blob/main/Chapter%2004/pointers-and-types/pointer-into-array.c